...
#' @param X is a Query ~.allchains object
#' @param Y is a Universe ~.allchains object
#' @details This barplot will show the percentage of the different unique chains contained in a Query and a Universe ~allchains objects. This function require ggplot2 to generate the graphics.
